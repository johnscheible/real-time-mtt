...
PARAMS="--outdir results/$SEQNAME.$POSTFIX\
		...
		--num_samples 5000 --num_burnin 1000 --num_thinning 100" # --motion_std_x 0.1 --motion_std_y 0.05 --motion_std_z 0.1 --sample_std_x 0.05 --sample_std_y 0.025 --sample_std_z 0.05"
